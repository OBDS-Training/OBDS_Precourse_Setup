...
8. Copy `cgat150.key` to your local computer from `/ifs/obds-training/sep20/shared/nx` using the [FileZilla instructions](filezilla_instructions.pdf). Click to use an alternative server key and supply the path to cgat150.key on your local computer.
